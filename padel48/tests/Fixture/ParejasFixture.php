...
class ParejasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'parejas_ibfk_3' => ['type' => 'foreign', 'columns' => ['grupo_id'], 'references' => ['enfrentamientos', 'grupo_id'], 'update' => 'restrict', 'delete' => 'cascade', 'length' => []],
            'parejas_ibfk_4' => ['type' => 'foreign', 'columns' => ['campeonato_id'], 'references' => ['categorias', 'campeonato_id'], 'update' => 'restrict', 'delete' => 'cascade', 'length' => []],
            'parejas_ibfk_5' => ['type' => 'foreign', 'columns' => ['categoria_id'], 'references' => ['categorias', 'id_categoria'], 'update' => 'restrict', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
